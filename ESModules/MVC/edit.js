...
import { EditAlunoView } from "./js/Views/Edit.aluno.view.js"
import { EditAlunoController } from './js/Controllers/Edit.aluno.controller.js'
...
document.querySelector('form').addEventListener('submit', function(e){
    ...
    window.location.assign('index.html')  //ao clicar em salvar, volta para a pagina inicial
})
