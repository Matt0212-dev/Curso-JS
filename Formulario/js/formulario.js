(function(){
    ...
    function showError(msg, cb){
        ...
        function hideErrorMessage(){
            ...
            feedbackMessageCloseBtn.removeEventListener('keyup', pressedKeyBoardOnByn) 

            if (typeof cb === 'function'){
                cb()
            }
        }
        function pressedKeyBoardOnByn(e){
        ...
        feedbackMessageCloseBtn.addEventListener('keyup', pressedKeyBoardOnByn)
    ...
    function checkLength(){
        let numeroLetrasDigitados = this.value.length
        let caracteresRestantes = parseInt(maxima) - parseInt(numeroLetrasDigitados)
